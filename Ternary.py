...
class Ternary():
    def __init__(self, value):
        """Initializes a Ternary object with a given logical value.

        Accepts True, False, or None to represent the three possible ternary logic states.

        Args:
            value: The logical value for the ternary object. Should be True, False, or None.
        """
        t = {True, False, None}
        self.value = value
